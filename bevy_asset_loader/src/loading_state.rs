...
pub(crate) struct AssetLoaderConfiguration<State: FreelyMutableState> {
    pub(crate) state_configurations: HashMap<State, LoadingConfiguration<State>>,
}
...
pub struct LoadingConfiguration<State: FreelyMutableState> {
    pub next: Option<State>,
    pub failure: Option<State>,
